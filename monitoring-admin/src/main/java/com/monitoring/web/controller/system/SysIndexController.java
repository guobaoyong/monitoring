...
import com.monitoring.common.core.domain.entity.SysMenu;
import com.monitoring.common.core.domain.entity.SysUser;
import com.monitoring.common.core.text.Convert;
import com.monitoring.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController {
    ...
    public String index(ModelMap mmap) {
        ...
        mmap.put("name",configService.selectConfigByKey("sys.platform.name"));
